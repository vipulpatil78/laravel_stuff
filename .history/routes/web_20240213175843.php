...
Route::post('/forgot-password/{token}', [ForgotPasswordController::class, 'forgotPasswordPost'])->name('forgot.password');
Route::get('reset-password', ForgotPasswordController::class, 'resetPassword')->name('resetpassword');
Route::get('reset-password', ForgotPasswordController::class, 'resetPasswordPost')->name('resetpassword');
